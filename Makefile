...
# Project:  3dvisor.pro
# Template: app
# Command: /home/xema/Qt/5.15.2/gcc_64/bin/qmake -o Makefile 3dvisor.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/xema/Qt/5.15.2/gcc_64/lib
...
Makefile: 3dvisor.pro ../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		3dvisor.pro
	$(QMAKE) -o Makefile 3dvisor.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
ply_object.o: ply_object.cpp ply_object3d.h \
		object3d.h \
		basic_object3d.h \
		colors.h \
		vertex.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ply_object.o ply_object.cpp
