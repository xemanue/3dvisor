#############################################################################
# Makefile for building: 3dvisor
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  3dvisor.pro
# Template: app
# Command: /home/xema/Qt/5.15.2/gcc_64/bin/qmake -o Makefile 3dvisor.pro -spec linux-g++ CONFIG+=qtquickcompiler
#############################################################################
...
QMAKE         = /home/xema/Qt/5.15.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/xema/Qt/5.15.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/xema/Qt/5.15.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 3dvisor1.0.0
DISTDIR = /home/xema/repos/3dvisor/.tmp/3dvisor1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/xema/Qt/5.15.2/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /home/xema/Qt/5.15.2/gcc_64/lib/libQt5Widgets.so /home/xema/Qt/5.15.2/gcc_64/lib/libQt5Gui.so /home/xema/Qt/5.15.2/gcc_64/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: 3dvisor.pro ../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		3dvisor.pro
	$(QMAKE) -o Makefile 3dvisor.pro -spec linux-g++ CONFIG+=qtquickcompiler
...
distdir: FORCE
	...
	$(COPY_FILE) --parents cilinder.h colors.h basic_object3d.h cone.h cube.h object3d.h axis.h rev_object3d.h tetrahedron.h glwidget.h window.h $(DISTDIR)/
	$(COPY_FILE) --parents axis.cpp basic_object3d.cpp cilinder.cpp cone.cpp cube.cpp object3d.cpp rev_object3d.cpp tetrahedron.cpp main.cpp glwidget.cpp window.cpp $(DISTDIR)/
...
cilinder.o: cilinder.cpp cilinder.h \
		...
		colors.h \
		vertex.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o cilinder.o cilinder.cpp
...
object3d.o: object3d.cpp object3d.h \
		...
		colors.h \
		vertex.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o object3d.o object3d.cpp

rev_object3d.o: rev_object3d.cpp rev_object3d.h \
		object3d.h \
		basic_object3d.h \
		colors.h \
		vertex.h
...
tetrahedron.o: tetrahedron.cpp tetrahedron.h \
		...
		colors.h \
		vertex.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o tetrahedron.o tetrahedron.cpp
